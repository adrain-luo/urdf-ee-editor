...
export class EnvironmentManager {
    ...
    setupLights() {
        ...
        this.lights.ambient.position.set(0, 0, 1);
        this.scene.add(this.lights.ambient);

        // Main directional light
        this.lights.directional = new THREE.DirectionalLight(0xffffff, Math.PI);
        this.lights.directional.position.set(4, 1, 10);
    ...
    setupGroundPlane() {
        ...
        this.groundPlane.position.z = 0;  // XY ground plane for URDF / ROS Z-up
    ...
    createReferenceGrid() {
        ...
        this.referenceGrid.rotation.x = Math.PI / 2;
        this.referenceGrid.position.z = 0; // XY grid aligned with ground
     ...
     */
    updateGroundPosition(minZ) {
        if (this.groundPlane) {
            this.groundPlane.position.z = minZ;
        }
        // Grid should also follow ground movement
        if (this.referenceGrid) {
            this.referenceGrid.position.z = minZ;
        }
    }
