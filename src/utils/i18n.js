...
export const translations = {
    'zh-CN': {
        ...
        // 帮助对话框
        'helpTitle': `URDF End-Effector Editor v${APP_VERSION}`,
        'about': '关于',
        'aboutContent': 'URDF End-Effector Editor 基于 Robot Viewer 构建，当前重点是稳定导入 URDF + meshes，并为末端执行器编辑流程做准备。<br><br>格式支持：URDF、Xacro、MJCF、USD（部分支持）<br>坐标语义：URDF / ROS，+Z up、+X forward、+Y left。<br><br>上游 Robot Viewer 由 <strong>范子琦</strong> 开发。',
        'projectHome': '项目主页',
        'email': '邮箱',
        'myGithub': '我的GitHub',
        'operations': '操作指南',
    ...
    'en-US': {
        ...
        'helpTitle': `URDF End-Effector Editor v${APP_VERSION}`,
        'about': 'About',
        'aboutContent': 'URDF End-Effector Editor is built on Robot Viewer. The current focus is stable URDF + meshes import and preparation for end-effector editing workflows.<br><br>Format Support: URDF, Xacro, MJCF, USD (partial support)<br>Coordinate semantics: URDF / ROS, +Z up, +X forward, +Y left.<br><br>Upstream Robot Viewer was developed by <strong>Ziqi Fan</strong>.',
